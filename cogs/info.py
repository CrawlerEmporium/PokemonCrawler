...
class Info(commands.Cog):
    ...
    async def botinfo(self, ctx):
        ...
        em.add_field(name='Source', value="[Click Here](https://github.com/CrawlerEmporium/PokemonCrawler)")
        em.add_field(name='Issue Tracker', value="[Click Here](https://github.com/CrawlerEmporium/PokemonCrawler)")
